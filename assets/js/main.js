...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (modal) {
    ...
    document.getElementById('verify-btn-1')?.addEventListener('click', handleVerificationAndRedirect);
    document.getElementById('verify-btn-2')?.addEventListener('click', handleVerificationAndRedirect);
  }
});
